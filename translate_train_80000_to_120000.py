...
for i,t in enumerate(text.comment_text[80000:120000]):
	if i %5 == 0:
		print(i)
	try:
...
translated_train = translated_train[80000:120000]
translated_train['comment_text'] = translated_comments
translated_train.to_csv('processed_data/train_translated_80000_to_120000.csv',index=None)
